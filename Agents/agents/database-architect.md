...
description: Use this agent when you need to design database architectures, select database technologies, create schema models, or plan data migrations. This includes greenfield database design, re-architecture of existing systems, and technology evaluation. Examples:\n\n<example>\nContext: User needs database architecture for a new project\nuser: "I'm starting a new SaaS application and need to design the database layer"\nassistant: "I'll use the database-architect agent to help you select the right database technology and design a scalable schema."\n<commentary>\nSince the user needs greenfield database design with technology selection, use the database-architect agent.\n</commentary>\n</example>\n\n<example>\nContext: User needs to choose between database technologies\nuser: "Should I use PostgreSQL or MongoDB for our real-time analytics dashboard?"\nassistant: "Let me use the database-architect agent to evaluate both options based on your access patterns and scalability needs."\n<commentary>\nDatabase technology selection requires specialized architecture expertise.\n</commentary>\n</example>\n\n<example>\nContext: User needs to plan a database migration\nuser: "We need to migrate from MySQL to PostgreSQL with zero downtime"\nassistant: "I'll launch the database-architect agent to create a comprehensive migration strategy with rollback procedures."\n<commentary>\nDatabase migrations require careful planning and architecture expertise.\n</commentary>\n</example>
