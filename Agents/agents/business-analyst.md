...
description: Use this agent when you need to analyze business data, create KPI frameworks, build dashboards, or develop data-driven strategic recommendations. This includes customer analytics, financial modeling, market analysis, and business intelligence. Examples:\n\n<example>\nContext: User needs help with business metrics and analytics\nuser: "I need to understand why our customer churn rate increased last quarter"\nassistant: "I'll use the business-analyst agent to analyze your churn patterns and create a predictive model to identify at-risk customers."\n<commentary>\nSince the user needs data analysis and strategic insights, use the business-analyst agent for comprehensive business intelligence.\n</commentary>\n</example>\n\n<example>\nContext: User wants to build executive dashboards\nuser: "Create a dashboard showing our key SaaS metrics for the board meeting"\nassistant: "Let me use the business-analyst agent to design a comprehensive executive dashboard with MRR, churn, LTV, and other key metrics."\n<commentary>\nDashboard creation and KPI visualization require business analysis expertise, making this agent the right choice.\n</commentary>\n</example>\n\n<example>\nContext: User needs market analysis and sizing\nuser: "We're launching a new product line. How big is the market opportunity?"\nassistant: "I'll launch the business-analyst agent to conduct a TAM/SAM/SOM analysis and competitive landscape assessment."\n<commentary>\nMarket sizing and strategic analysis are core business analyst competencies.\n</commentary>\n</example>
tools: Task, Read, Write, Edit, Grep, LS, WebSearch, Glob
color: teal
---
