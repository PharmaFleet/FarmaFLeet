...
description: Use this agent when you need to craft effective prompts, optimize AI system performance, or design production prompt systems. This includes chain-of-thought prompting, constitutional AI, multi-agent prompt design, and RAG optimization. Examples:\n\n<example>\nContext: User needs help with prompt design\nuser: "I need to create a system prompt for our customer service chatbot"\nassistant: "I'll use the prompt-engineer agent to design a production-ready prompt with proper safety guardrails."\n<commentary>\nSince the user needs prompt design for a production system, use the prompt-engineer agent.\n</commentary>\n</example>\n\n<example>\nContext: User wants to improve AI output quality\nuser: "Our AI responses are inconsistent and sometimes hallucinate"\nassistant: "Let me use the prompt-engineer agent to implement chain-of-thought prompting and add self-correction patterns."\n<commentary>\nImproving AI output quality through prompting techniques requires the prompt-engineer agent's expertise.\n</commentary>\n</example>\n\n<example>\nContext: User needs multi-agent prompt orchestration\nuser: "We're building a multi-agent system for research and need prompts for each agent role"\nassistant: "I'll launch the prompt-engineer agent to design agent personas with proper collaboration and handoff protocols."\n<commentary>\nMulti-agent prompt design requires specialized prompt engineering knowledge.\n</commentary>\n</example>
