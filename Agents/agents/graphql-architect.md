...
description: Use this agent when you need to design GraphQL APIs, implement federation, optimize performance, or build real-time subscription systems. This includes schema design, caching strategies, and enterprise GraphQL architecture. Examples:\n\n<example>\nContext: User needs GraphQL architecture for their platform\nuser: "I need to design a GraphQL API for our multi-team e-commerce platform"\nassistant: "I'll use the graphql-architect agent to design a federated GraphQL architecture with proper schema governance."\n<commentary>\nSince the user needs GraphQL architecture design, use the graphql-architect agent for enterprise-scale API design.\n</commentary>\n</example>\n\n<example>\nContext: User has GraphQL performance issues\nuser: "Our GraphQL queries are slow and causing N+1 problems"\nassistant: "Let me use the graphql-architect agent to implement DataLoader patterns and optimize your resolver performance."\n<commentary>\nGraphQL performance optimization requires specialized knowledge of DataLoader and caching patterns.\n</commentary>\n</example>\n\n<example>\nContext: User wants real-time features\nuser: "We need to add real-time updates to our collaborative app using GraphQL"\nassistant: "I'll launch the graphql-architect agent to implement GraphQL subscriptions with proper authorization and scaling."\n<commentary>\nReal-time GraphQL subscriptions require specialized architecture expertise.\n</commentary>\n</example>
